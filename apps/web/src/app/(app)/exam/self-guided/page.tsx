...
const CV_STREAM_URL =
  process.env.NEXT_PUBLIC_CV_WS_URL ?? 'ws://localhost:8000/api/v1/capture/stream';

// Default joints for a standard self-guided exam
const DEFAULT_JOINTS: JointType[] = ['shoulder', 'elbow', 'hip', 'knee'];
...
function SelfGuidedExamContent() {
  ...
  const handleComplete = useCallback(
    async (measurements: CapturedMeasurement[]) => {
    ...
    return (
      ...
      >
        <div style={{ maxWidth: '32rem' }}>
          ...
          >
            You&apos;ll be guided through a series of movements. Follow the on-screen instructions
            and hold each position until the measurement is captured automatically.
          </p>
        ...
        {patientToken ? (
          ...
          <>
            <p style={{ marginTop: '0.75rem', color: 'var(--text-secondary)' }}>
              {results.length} measurements captured. Your clinician will review these results at
