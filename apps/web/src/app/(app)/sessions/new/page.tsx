          ...
          >
            ...
            {sessionDurationMin !== null && (
              <p style={{ color: 'var(--accent)', marginBottom: 4, fontSize: 14, fontWeight: 500 }}>
                Note ready. Your session took {sessionDurationMin} minute
                {sessionDurationMin === 1 ? '' : 's'} — {Math.max(0, 20 - sessionDurationMin)}{' '}
                minutes saved vs manual documentation.
              </p>
            )}
            <p style={{ color: 'var(--text-tertiary)', marginBottom: 24, fontSize: 15 }}>
              Copy the note below into your EMR.
            </p>
            {generatedNote && <NoteRenderer note={generatedNote} />}
