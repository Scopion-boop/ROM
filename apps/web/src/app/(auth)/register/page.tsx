  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        {!inviteToken && (
          <div>
            <label htmlFor="reg-clinic" style={labelStyle}>
        ...
        <div>
          <label htmlFor="reg-role" style={labelStyle}>
            Role
          </label>
          <select
            id="reg-role"
      ...
      <p
        style={{ textAlign: 'center', fontSize: 13, color: 'var(--text-tertiary)', marginTop: 12 }}
      >
