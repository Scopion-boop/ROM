                ...
                >
                    <div style={{ maxWidth: 480, width: '100%', textAlign: 'center' }}>
                        ...
                        >
                            ...
                            >
                                <li style={{ color: 'var(--text-secondary)', fontSize: '0.9375rem', lineHeight: 1.5 }}>
...
function Footer() {
    return (
        ...
        >
            Powered by <span style={{ color: 'var(--accent)' }}>PhysioLens</span> — Secure clinical assessment platform
        </footer>
    );
}
