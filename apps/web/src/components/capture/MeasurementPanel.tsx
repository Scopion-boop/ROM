...
export default function MeasurementPanel({
  ...
  if (measurements.length === 0) {
    return (
      <div
        data-testid="measurement-panel-empty"
        className="card"
          ...
          <tr>
            {[
              ...
              <th
                ...
                style={{
                  textAlign:
                    h === 'ROM (°)' || h === 'Normal (°)' || h === 'Confidence' ? 'right' : 'left',
                  padding: '10px 16px',
                  fontSize: 11,
                  fontWeight: 600,
        ...
        <tbody>
          {measurements.map((m, i) => (
            <tr
              ...
              style={{
                borderBottom:
                  i < measurements.length - 1 ? '1px solid var(--border-secondary)' : 'none',
            ...
            >
              ...
              <td style={{ padding: '12px 16px' }}>
                <ProgressBar percent={m.percentOfNormal} status={m.status} />
              </td>
              <td style={{ padding: '12px 16px' }}>
