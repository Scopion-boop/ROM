...
describe('rom-utils', () => {
    ...
    describe('enrichWithNormative', () => {
        it('adds normative data to a shoulder flexion measurement', () => {
            const measurements = [makeMeasurement({ joint: 'shoulder', movement: 'flexion', romDegrees: 150 })];
        ...
        it('classifies severe deficit correctly', () => {
            ...
            const measurements = [makeMeasurement({ joint: 'shoulder', movement: 'flexion', romDegrees: 60 })];
            const result = enrichWithNormative(measurements);
        ...
        it('classifies normal ROM correctly', () => {
            ...
            const measurements = [makeMeasurement({ joint: 'shoulder', movement: 'flexion', romDegrees: 170 })];
            const result = enrichWithNormative(measurements);
        ...
        it('flags suspect accuracy when ROM exceeds 120% of normal', () => {
            ...
            const measurements = [makeMeasurement({ joint: 'shoulder', movement: 'flexion', romDegrees: 220 })];
