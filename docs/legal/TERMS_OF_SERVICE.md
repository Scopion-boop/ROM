...
**Provider:** [YOUR COMPANY NAME] ("Company," "we," "us," or "our")
...
By accessing or using the ROM Measurement Platform (the "Platform"), you ("User," "you," or "your") agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you must not use the Platform.

**Healthcare Professional Acknowledgment:** This Platform is designed exclusively for licensed healthcare professionals. By using the Platform, you represent and warrant that you are a licensed healthcare professional authorized to provide clinical services in your jurisdiction.

**Binding Agreement:** These Terms constitute a legally binding agreement between you and [YOUR COMPANY NAME]. Your continued use of the Platform after any modifications to these Terms constitutes acceptance of those changes.
...
- Comply with all applicable laws, including HIPAA (if in the U.S.)
...
**Account Sharing Prohibited:** You may not share your account credentials with others or allow unauthorized individuals to access the Platform using your credentials.
...
Upon termination, your access will cease, but patient data will be retained per our data retention policies.
...
Subject to these Terms, we grant you a limited, non-exclusive, non-transferable, revocable license to access and use the Platform for clinical assessment and documentation purposes.
...
- Export assessment data for patient records
- Integrate with your electronic health record (EHR) system (if supported)
...
- Violate any applicable laws, including HIPAA, GDPR, or data protection regulations
...
**Research Use:** Use of Platform data for research requires explicit consent from patients and approval from an Institutional Review Board (IRB).

---

## 4. Clinical Use and Professional Responsibility

### 4.1 Clinical Judgment Requirement
...
- You are solely responsible for patient care decisions and outcomes
...
- Requiring independent verification before clinical use

**Professional Liability:** You retain full professional and legal liability for all clinical decisions and patient care, regardless of Platform output.
...
- Consent for AI-powered analysis (if used)
...
If you provide feedback, suggestions, or ideas about the Platform, you grant us a perpetual, irrevocable, worldwide, royalty-free license to use, modify, and incorporate such feedback without compensation or attribution.
...
- Subscriptions are billed [monthly/annually] in advance
...
We reserve the right to change pricing with **30 days' notice**. Price changes will not affect your current subscription period but will apply upon renewal.
...
We warrant that the Platform will substantially conform to its documented functionality. Our sole obligation for breach of this warranty is to repair or replace the non-conforming service or, if we cannot do so, refund your fees for the affected period.

### 7.2 Disclaimer of Warranties

**TO THE MAXIMUM EXTENT PERMITTED BY LAW, THE PLATFORM IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING:**

- **Merchantability** or fitness for a particular purpose
- **Accuracy or reliability** of measurements or AI-generated content
...
- Use of the Platform will improve patient outcomes

**Medical Device Status:** [OPTION A: This Platform is NOT a medical device as defined by the FDA and does not diagnose, treat, or cure any disease.] [OPTION B: This Platform is an FDA-cleared Class II medical device (510(k) number: K######) for [specified intended use].]
...
- Malpractice claims arising from clinical use
...
You agree to indemnify, defend, and hold harmless [YOUR COMPANY NAME], its officers, directors, employees, and agents from any claims, damages, losses, or expenses (including reasonable attorneys' fees) arising from:

- Your violation of these Terms
- Your misuse of the Platform or patient data
- Clinical decisions or patient care based on Platform output
- Your violation of applicable laws (HIPAA, state medical practice acts, etc.)
- Third-party claims alleging medical malpractice or negligence
...
### 10.1 BAA Requirement (U.S. Healthcare Providers)

If you are a HIPAA Covered Entity, a separate Business Associate Agreement (BAA) is required and incorporated into these Terms by reference.

**To execute a BAA:** Contact compliance@[YOUR DOMAIN].com
...
- Provide access to PHI upon request
...
Our Privacy Policy is incorporated into these Terms and describes how we collect, use, and protect your data. By using the Platform, you agree to the Privacy Policy.
...
- Users have rights to access, rectify, erase, and port personal data

**Data Processing Addendum (DPA):** Contact privacy@[YOUR DOMAIN].com for DPA execution
...
These Terms remain in effect while you access or use the Platform.
...
- After 30 days, data may be deleted per our retention policy

**Data Export:** You may request a data export within 30 days of termination. Exports are provided in JSON format.
...
**Class Action Waiver:** You agree to resolve disputes individually and waive the right to participate in class actions or collective proceedings.

### 13.3 Exceptions to Arbitration

You may opt out of arbitration by sending written notice within 30 days of accepting these Terms to: legal@[YOUR DOMAIN].com
...
These Terms, together with the Privacy Policy and any executed BAA/DPA, constitute the entire agreement between you and [YOUR COMPANY NAME] regarding the Platform.
...
We are not liable for delays or failures caused by events beyond our reasonable control (natural disasters, war, pandemics, internet outages, etc.).

### 14.7 Independent Contractors

You and [YOUR COMPANY NAME] are independent contractors. These Terms do not create a partnership, joint venture, or employment relationship.
...
**HIPAA/Compliance:** compliance@[YOUR DOMAIN].com
...
- You understand the Platform is an assessment tool, not a substitute for clinical judgment
...
⚠️ **Medical Professional Use Only**
⚠️ **Not a Diagnostic Device** (unless FDA-cleared)
⚠️ **Clinical Judgment Required for All Patient Care Decisions**
⚠️ **HIPAA BAA Required for U.S. Healthcare Providers**
