# Musculoskeletal ROM - Team Lead Planning Workspace (v2)
...
4. Run delivery workflow from `07-dev-agent-orchestration.md` + `08-delivery-roadmap-release-ops.md`.
5. Validate quality gates using `09-test-validation-clinical-plan.md`.
6. Execute backlog from `10-backlog-implementation-sprints.md`.
...
- `04-ai-cv-measurement-design.md`: CV/AI pipeline and measurement logic
- `05-security-privacy-compliance.md`: Security baseline and healthcare controls
- `06-legal-regulatory-doc-pack.md`: Legal artifacts and regulatory path options
- `07-dev-agent-orchestration.md`: Team lead + multi-agent operating model
- `08-delivery-roadmap-release-ops.md`: Release plan, SRE/ops, go-live gates
- `09-test-validation-clinical-plan.md`: Test strategy + clinical validation framework
- `10-backlog-implementation-sprints.md`: Prioritized implementation plan
