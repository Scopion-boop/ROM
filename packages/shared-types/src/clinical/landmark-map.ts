...
export const LANDMARK_MAP: Partial<Record<LandmarkKey, LandmarkTriple>> = {
  ...
  'shoulder:internal_rotation:left': {
    proximal: 15,
    center: 13,
    distal: 11,
    preferredView: 'transverse',
  },
  'shoulder:internal_rotation:right': {
    proximal: 16,
    center: 14,
    distal: 12,
    preferredView: 'transverse',
  },
  'shoulder:external_rotation:left': {
    proximal: 15,
    center: 13,
    distal: 11,
    preferredView: 'transverse',
  },
  'shoulder:external_rotation:right': {
    proximal: 16,
    center: 14,
    distal: 12,
    preferredView: 'transverse',
  ...
  'shoulder:horizontal_adduction:left': {
    proximal: 12,
    center: 11,
    distal: 13,
    preferredView: 'transverse',
  },
  'shoulder:horizontal_adduction:right': {
    proximal: 11,
    center: 12,
    distal: 14,
    preferredView: 'transverse',
  },
  'shoulder:horizontal_abduction:left': {
    proximal: 12,
    center: 11,
    distal: 13,
    preferredView: 'transverse',
  },
  'shoulder:horizontal_abduction:right': {
    proximal: 11,
    center: 12,
    distal: 14,
    preferredView: 'transverse',
  ...
  'hip:internal_rotation:left': {
    proximal: 27,
    center: 25,
    distal: 23,
    preferredView: 'transverse',
  },
  'hip:internal_rotation:right': {
    proximal: 28,
    center: 26,
    distal: 24,
    preferredView: 'transverse',
  },
  'hip:external_rotation:left': {
    proximal: 27,
    center: 25,
    distal: 23,
    preferredView: 'transverse',
  },
  'hip:external_rotation:right': {
    proximal: 28,
    center: 26,
    distal: 24,
    preferredView: 'transverse',
  ...
  'cervical_spine:flexion:midline': {
    proximal: 0,
    center: 11,
    distal: 23,
    preferredView: 'sagittal',
  },
  'cervical_spine:extension:midline': {
    proximal: 0,
    center: 11,
    distal: 23,
    preferredView: 'sagittal',
  },
  'cervical_spine:lateral_flexion_left:midline': {
    proximal: 7,
    center: 0,
    distal: 8,
    preferredView: 'frontal',
  },
  'cervical_spine:lateral_flexion_right:midline': {
    proximal: 8,
    center: 0,
    distal: 7,
    preferredView: 'frontal',
  },
  'cervical_spine:rotation_left:midline': {
    proximal: 0,
    center: 7,
    distal: 11,
    preferredView: 'transverse',
  },
  'cervical_spine:rotation_right:midline': {
    proximal: 0,
    center: 8,
    distal: 12,
    preferredView: 'transverse',
  ...
  'thoracic_spine:flexion:midline': {
    proximal: 11,
    center: 23,
    distal: 25,
    preferredView: 'sagittal',
  },
  'thoracic_spine:extension:midline': {
    proximal: 11,
    center: 23,
    distal: 25,
    preferredView: 'sagittal',
  },
  'thoracic_spine:rotation_left:midline': {
    proximal: 11,
    center: 12,
    distal: 24,
    preferredView: 'transverse',
  },
  'thoracic_spine:rotation_right:midline': {
    proximal: 12,
    center: 11,
    distal: 23,
    preferredView: 'transverse',
  ...
  'lumbar_spine:flexion:midline': {
    proximal: 11,
    center: 23,
    distal: 25,
    preferredView: 'sagittal',
  },
  'lumbar_spine:extension:midline': {
    proximal: 11,
    center: 23,
    distal: 25,
    preferredView: 'sagittal',
  },
  'lumbar_spine:lateral_flexion_left:midline': {
    proximal: 11,
    center: 23,
    distal: 12,
    preferredView: 'frontal',
  },
  'lumbar_spine:lateral_flexion_right:midline': {
    proximal: 12,
    center: 24,
    distal: 11,
    preferredView: 'frontal',
  },
  'lumbar_spine:rotation_left:midline': {
    proximal: 11,
    center: 23,
    distal: 24,
    preferredView: 'transverse',
  },
  'lumbar_spine:rotation_right:midline': {
    proximal: 12,
    center: 24,
    distal: 23,
    preferredView: 'transverse',
